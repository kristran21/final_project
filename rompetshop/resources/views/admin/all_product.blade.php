          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
              ...
              if($pro->product_status==0){
                ?>
                   <a href="{{URL::to('/unactive-product/'.$pro->product_id)}}"><span class="an-danh-muc">Hide</span></a>
                 <?php  
              }else{
                ?>
                  <a href="{{URL::to('/active-product/'.$pro->product_id)}}"><span class="hienthi-danh-muc">Show</span></a>
                 <?php
                }
              ?>
            </span></td>
