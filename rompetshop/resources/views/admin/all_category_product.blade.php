          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
              ...
              if($cate_pro->category_status==0){
                ?>
                   <a href="{{URL::to('/unactive-category-product/'.$cate_pro->category_id)}}"><span class="an-danh-muc">Hide</span></a>
                 <?php  
              }else{
                ?>
                  <a href="{{URL::to('/active-category-product/'.$cate_pro->category_id)}}"><span class="hienthi-danh-muc">Show</span></a>
                 <?php
                }
              ?>
            </span></td>
