...
<body>
	...
	<section>
		<div class="container">
			<h2 style="text-align: center; color:#fe980f">About Rom Pet Shop </h2>
			<img style="display: block ; margin-left : auto ; margin-right:auto ; width:14%" src="{{asset('frontend/images/home/logo1.png')}}" alt="">
			<p style="font-family: Roboto, sans-serif; font-size: 15px ; text-align: justify; margin-bottom : 35px ">Derived from the passion for pets, especially the Chinese reptile line, is a pet lover and wants all pet lovers like me to always own pets with good health, quality, and color. and beautiful appearance with the best price, along with that Trung also wants to share his experience in raising techniques, how to care for and cure diseases for pets. Therefore, I decided to open Rom Pet Shop with the purpose of selling pet products of clear origin and providing technical advice on pet raising for everyone. </p>
		</div>
	</section>
