					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="{{URL::to('/trang-chu')}}">Shop<i class="fa fa-angle-down"></i></a>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{('frontend/images/home/gecko3.jpg')}}" class="girl img-responsive" alt="" />
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{('frontend/images/home/gecko2.jpg')}}" class="girl img-responsive" alt="" />
									{{-- <img src="{{('/frontend/images/home/pricing.png')}}"  class="pricing" alt="" /> --}}
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{('frontend/images/home/gecko1.jpg')}}" class="girl img-responsive" alt="" />
									{{-- <img src="{{('/frontend/images/home/pricing.png')}}" class="pricing" alt="" /> --}}
								</div>
							</div>
...
<section id="cart_items">
    <div class="container">
        ...
        <div class="register-req">
            <p>Register or login to checkout cart and review purchase history</p>
        </div><!--/register-req-->
        ...
        <div class="shopper-informations">
            <div class="row">
                ...
                <div class="col-sm-8 clearfix">
                    <div style="text-align: center" class="bill-to">
                        ...
                        <div class="form-one">
                            <form action="{{URL::to('/save-checkout-customer')}}" method="POST">
                                ...
                                <textarea  name="shipping_notes"  placeholder="Notes on your order" rows="16"></textarea>
