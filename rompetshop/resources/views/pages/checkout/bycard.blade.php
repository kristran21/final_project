...
<section id="cart_items">
    <div class="container">
        ...
        <div class="jumbotron text-center">
            ...
            <h2>👇 Banking your order to this account 👇 </h2>
            <h3>Chủ tài khoản : Trần Kiên Trung</h3>
            <h3>STK : 989888998888</h3>
            <h3 style="margin-bottom: 13px">Ngân hàng MB Bank</h3>
            <p style="margin-top: 8px" class="lead"><strong>Delivery time will be 3-4 days. Thank you for your support.</strong> </p>
            <hr>
            <p>
              Having trouble? <a href="https://www.facebook.com/kristrannnn/">Contact us</a>
            </p>
            <p class="lead">
